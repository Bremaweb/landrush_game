...
skins.formspec.main = function(name)
	...
	local formspec = "size[8,7.5]"
		.. "button_exit[0,0;2,.5;main;Close]"
...
unified_inventory.register_button("skins", {
	...
	action = function(player)
		minetest.show_formspec(player:get_player_name(),"skins",skins.formspec.main(player:get_player_name()))
	end,
})

--unified_inventory.register_page("skins", {
---	get_formspec = function(player, perplayer_formspec)
--		return skins.formspec.main(player:get_player_name())
--	end,
--})
